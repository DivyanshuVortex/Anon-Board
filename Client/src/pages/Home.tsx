    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] flex flex-col gap-24 py-16 px-6 lg:px-24 hide-scrollbar">
      ...
      >
        ...
        <div className="relative w-full lg:w-96 h-60 rounded-xl overflow-hidden group shadow-lg">
          ...
          />
          {/* Overlay */}
          <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center text-center px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out">
            <p className="text-white text-4xl font-semibold mb-2 transform translate-y-4 group-hover:translate-y-0 transition-all duration-900">
